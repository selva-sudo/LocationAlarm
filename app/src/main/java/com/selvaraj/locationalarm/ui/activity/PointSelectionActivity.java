...
import com.selvaraj.locationalarm.BuildConfig;
import com.selvaraj.locationalarm.DeLog;
import com.selvaraj.locationalarm.R;
import com.selvaraj.locationalarm.service.FetchAddressIntentService;
 ...
 * </br>By calling this activity for result, the returning intent will provide the location selected in the {@linkplain com.selvaraj.locationalarm.ui.activity.PointSelectionActivity#EXTRA_LATITUDE} and
 * {@linkplain com.selvaraj.locationalarm.ui.activity.PointSelectionActivity#EXTRA_LONGTITUDE} for the coordinates. The result might also include the value {@linkplain com.selvaraj.locationalarm.ui.activity.PointSelectionActivity#EXTRA_ADDRESS}
    ...
    private void setUpMapIfNeeded() {
        ...
        if (mMap == null) {
            ...
            if (fragmentById != null) {
                fragmentById.getMapAsync(new OnMapReadyCallback() {
                    @Override

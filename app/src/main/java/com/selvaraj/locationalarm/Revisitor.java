...
/**
 * The Revisitor keeps a list of {@linkplain com.selvaraj.locationalarm.entity.LocationPlace} with their names and co-ords, in order to be used through the app.
 * <p>Created by Selvaraj on 22/02Selvaraj5.</p>
 */
